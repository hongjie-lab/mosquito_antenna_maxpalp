...
seurat.combined <- readRDS(file = file.path(anchorFolderPath, 'seurat.combined.rds') )
...
saveRDS(antenna.neuron, file = 
          file.path(receptorFolderPath, 'antenna.neuron.rds') )

save.image(file = file.path(receptorFolderPath, 'antenna.neuron.RData') )
