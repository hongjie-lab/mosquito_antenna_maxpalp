...
sratDF <- readRDS( file.path('Analysis/10282021_MaxPalp', 
                                      paste('2', normalizationMethod, dataFolder, 'DoubletFinder.rds', sep = '.')) )
...
saveRDS(srat.neuron, file = 
          file.path(receptorFolderPath, 'srat.neuron.rds') )

save.image(file = file.path(receptorFolderPath, 'srat.neuron.RData') )
